...
const VideoPlayerC = ({src, srcId, title, btn = false, auto = true, poster, muted = true}:{src?:string, srcId?:string, title?: string, auto?: boolean, btn?: boolean, poster?:  React.ReactElement, muted?: boolean}) => {
    ...
    function calcQuality() {
        ...
        if(width) {
            const resQuality = (it: number) => (it / 3) * 4 > width

            const qlty = videoSize[videoSize.findIndex(resQuality)]
            return `https://vz-59c0616c-d60.b-cdn.net/288586aa-5453-4518-98b6-fad98f70d902/play_${qlty}p.mp4`
        }
    }
    ...
    const setUrl = (source: string) => {
        ...
        //         // @ts-ignore
        //         playerInt?.bufferController?.media.removeAttribute('src');
        ...
        //             }
        //             // @ts-ignore
        //             hls.attachMedia(playerInt?.bufferController?.media);
        ...
        //                 // @ts-ignore
        //                 playerInt?.bufferController?.media.setAttribute('src', sourceM3u8); // The media starts playing on iphone right here
        //             }
        //         }
        //     }
        //
        ...
        // // if(playerInt) {
        // //     // @ts-ignore
        // //     const playerInternal = playerInt.getInternalPlayer('hls')
        // //     console.log(playerInternal)
