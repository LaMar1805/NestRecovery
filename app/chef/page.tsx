...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                alt: testData.data.meta.chef.title,
        ...
        <main className={'page-chef'}>
            ...
            <Section
                ...
                text={<div className={'section__text'}>
                    <p>Originally from Lyon, France, Jordan trained under French Michelin Star Chefs Paul Bocuse and Joseph Viola. After graduating best-in-class from Ecole de Cuisine Gourmets by Institut Paul Bocuse, Jordan further refined his unique style in the best restaurants of Macau, Shanghai and Jakarta and The Beverly Hills Hotel in the USA.</p>
