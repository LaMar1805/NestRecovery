                ...
                gallery={
                    <Suspense>
                        <ComponentC poster={<Image  style={{
                                ...
                                title={'Breathtaking canyon views'}  btn={true} muted={false} auto={false} src={'https://vz-59c0616c-d60.b-cdn.net/7a653335-5206-4697-9f2e-29c2b4d6c6a8/playlist.m3u8?v=1692318995'} />
                    </Suspense>
